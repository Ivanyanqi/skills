# Generated by Powerlevel10k configuration wizard on 2026-05-01 at 03:31 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ICON_FOREGROUND=51
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%81F'   # cool blue foreground
      local   modified='%179F'  # amber foreground
      local  untracked='%117F'  # brighter cool blue foreground
      local conflicted='%203F'  # soft red foreground
    else
  ...
  typeset -g POWERLEVEL9K_TIME_ICON_FOREGROUND=110
